...
class TfPoseEstimator:
    ...
    def __init__(self, graph_path, target_size=(320, 240)):
        ...
        print(self.tensor_output, self.tensor_image)
        ...
        saver = tf.train.import_meta_graph(graph_path+'.meta')
        saver.restore(self.persistent_sess, graph_path)
        ...
        print(target_size[1], target_size[0])

        self.persistent_sess.run(
            self.tensor_output,
            feed_dict={
                self.tensor_image: np.ndarray(shape=(1, target_size[1], target_size[0], 3))
            }
        )

        print("7heellllllllllll")
        print("heellllllllllll")
        print("heellllllllllll")
        '''
